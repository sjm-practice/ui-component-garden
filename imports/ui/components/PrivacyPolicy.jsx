...
const PrivacyPolicy = () => (
  <div style={{ padding: 40 }}>
    ...
    <p>
      This privacy policy discloses the privacy practices for Eat Drink Healthy. This
      privacy policy applies solely to information collected by this web application and
    ...
    <ol>
      <li>
        ...
        site or app, how it is used and with whom it may be shared.
      </li>
    ...
    <p>
      ...
      access to/collect information that you voluntarily give us via registration or other
    ...
    <p>
      ...
      application, or respond to you regarding the reason you contacted us. We will not
    ...
    <p>
      ...
      about product updates, or changes to this privacy policy.
    </p>

    <h2>Your Access to and Control Over Information</h2>
    <p>
      You may opt out of any future contacts from us at any time. You can do the following
      at any time by contacting us via the contact form on our support page:
    </p>
    ...
    <p>
      ...
      information via the website or app, your information is protected both online and
      offline.
    </p>
    ...
    <p>
      ...
      by looking for a closed lock icon at the bottom of your web browser, or looking for
    ...
    <h2>Links</h2>
    <p>
      This web site and app may contain links to other sites. Please be aware that we are
      not responsible for the content or privacy practices of such other sites. We
      encourage our users to be aware when they leave our site or app and to read the
    ...
    <h2>Updates</h2>
    <p>
      Our Privacy Policy may change from time to time and all updates will be posted on
      this page.
    </p>
